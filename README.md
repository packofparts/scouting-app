...
2. Connect an android device to your computer via USB. (Make sure to enable USB debugging!)
3. Hit run on android studio. The app should be installed on your mobile device.
